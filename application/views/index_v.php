...
<html lang="zxx">
    <head>
        ...
        <!-- flaticon css  -->
        <link rel="stylesheet" type="text/css" href="<?=base_url();?>assets/css/ico-moon-fonts.css" />
        <!-- font awesome icon css -->
        <link rel="stylesheet" type="text/css" href="<?=base_url();?>assets/css/all.min.css">
        <!-- spacing css -->
        <link rel="stylesheet" type="text/css" href="<?=base_url();?>assets/css/sc-spacing.css" />
        <!-- style css -->
    ...
    <body>
        ...
        <div class="home_v4_bg">
            
        </div>
        <div class="home_v4_body_content">
            <canvas id="canvas" class="home_v4_fire_fly_bg"></canvas>
        
            <div class="home_v4_body_items">
                <!--Header Start-->
                ...
                <div class="gamfi-footer-section gamfi_home_v4_footer_section bg-transparent">
                    <div class="container">
                    ...
                    <div class="footer-area home_v4_footer_area footer-bg-transparent">
                        <div class="container">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="connect-section">
                            <ul class="heading-list">
                                <li><a href="#" class="connect-meta"><span><img src="assets/images/icons/meta-mask.png" alt="Meta-mask-Image"></span>MetaMask</a></li>
        ...
        <!-- Meta Mask Connect -->
        <script src="<?=base_url();?>assets/js/web3.min.js"></script>
        <script src="<?=base_url();?>assets/js/metamask.js"></script>
        ...
        <!-- Time Counter js -->
        <script src="<?=base_url();?>assets/js/time-counter.js"></script>
        <script src="<?=base_url();?>assets/js/metamaskhandler.js"></script> 
        <!-- main js -->
        <script src="<?=base_url();?>assets/js/main.js"></script>
        <!-- slickSlider js -->
        <script src="<?=base_url();?>assets/js/slick.min.js"></script>
        <!-- Fire Flys JS -->
        <script src="<?=base_url();?>assets/js/fireflys.js"></script>
        <!-- home 4 JS -->
        <script src="<?=base_url();?>assets/js/custom/home4.js"></script>
    </body>
</html>